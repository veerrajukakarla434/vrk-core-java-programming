...
.bg-yellow-light **So Nothing will happens if we declare we can do all operations and we will get results without any exception, But to get persistence related exceptions we shoud use @Repository and to make our intent is clear we should use @ Service  wherever applicable.**  
